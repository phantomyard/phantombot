...
//
// This module was split into core/ + telegram/ submodules. To preserve the
// EXACT public API every importer and test depends on, re-export everything
// that moved out under its original name. Do NOT remove a re-export without
// auditing every importer of `channels/telegram.ts`.
// ---------------------------------------------------------------------------
export {
  formatAttachmentUserText,
  inboxDir,
